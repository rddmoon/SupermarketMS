...
namespace SupermarketTuto
{
    public partial class SellingForm : Form
    {
        ...
        {
            e.Graphics.DrawString("AREA51 SUPERMARKET", new Font("Century Gothic", 25, FontStyle.Bold), Brushes.Red, new Point(235));
            ...
            e.Graphics.DrawString("~Have A Nice Day~", new Font("Century Gothic", 20, FontStyle.Italic), Brushes.Red, new Point(280,230));
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
                ...
                SqlCommand cmd = new SqlCommand(query, Con);
                cmd.ExecuteNonQuery();
                MessageBox.Show("All bill Deleted Successfully");
                Con.Close();
                /*populate();
                Sid.Text = "";
                Sname.Text = "";
